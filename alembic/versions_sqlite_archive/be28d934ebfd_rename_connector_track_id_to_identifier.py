...
down_revision: str | None = "e68ef4e64972"
...
def upgrade() -> None:
    ...
    connector_tracks_cols = {
        col["name"] for col in inspector.get_columns("connector_tracks")
    }
    ...
    connector_playlists_cols = {
        col["name"] for col in inspector.get_columns("connector_playlists")
    }
    ...
    playlist_mappings_cols = {
        col["name"]: col for col in inspector.get_columns("playlist_mappings")
    }
