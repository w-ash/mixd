...
def downgrade() -> None:
    op.drop_constraint(
        "chk_review_match_weight_range", "match_reviews", type_="check"
    )
    op.drop_constraint(
        "chk_review_confidence_range", "match_reviews", type_="check"
    )
    op.drop_constraint(
        "chk_mapping_confidence_range", "track_mappings", type_="check"
    )
