...
async def find_orphans_window_function() -> list[dict]:
    ...
    logger.info(
        "🔍 Finding orphaned connector_tracks using window function optimization..."
    )
...
async def main(
    benchmark: bool = False, create_index: bool = False, method: str = "left_join"
):
...
def cli_main():
    ...
    def detect(
        benchmark: bool = typer.Option(
            False, "--benchmark", help="Benchmark all approaches"
        ),
        create_index: bool = typer.Option(
            False, "--create-index", help="Create optimized index"
        ),
        method: str = typer.Option(
            "left_join", "--method", help="Detection method to use"
        ),
    ):
