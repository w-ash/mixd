...
export function EmptyState({
  ...
  return (
    <div
      role={role}
      className="flex flex-col items-center justify-center gap-4 rounded-lg border border-border-muted bg-surface-sunken px-8 py-16 text-center animate-fade-up"
    >
      {icon && (
        <span
