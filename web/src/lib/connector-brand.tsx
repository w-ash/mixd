...
export const connectorBrand: Record<string, ConnectorBrand> = {
  ...
  tidal: {
    label: "TIDAL",
    logo: logoFromPath(TIDAL_PATH),
    textColor: "text-tidal",
    borderColor: "border-l-tidal",
    buttonClass:
      "bg-tidal/15 text-tidal border border-tidal/30 hover:bg-tidal/25",
    description: "Playlists, favorites, and library sync",
  },
};
