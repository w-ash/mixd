...
export const getGetSpotifyHistoryQueueApiV1ImportsSpotifyHistoryQueueGetResponseMock = (overrideResponse: Partial<Extract<ImportQueueResponse, object>> = {}): ImportQueueResponse => ({queue_id: faker.string.alpha({length: {min: 10, max: 20}}), operation_id: faker.string.alpha({length: {min: 10, max: 20}}), started_at: faker.date.past().toISOString().slice(0, 19) + 'Z', entries: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({filename: faker.string.alpha({length: {min: 10, max: 20}}), position: faker.number.int(), status: faker.helpers.arrayElement(["queued",faker.helpers.arrayElement(Object.values(OperationStatus)),]), operation_id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), run_id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), size_bytes: faker.number.int(), started_at: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), settled_at: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), counts: faker.helpers.arrayElement([faker.helpers.arrayElement([{
        [faker.string.alphanumeric(5)]: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),faker.number.int(),faker.number.float({fractionDigits: 2}),faker.datatype.boolean(),[],null,])
      },null,]), undefined])})), ...overrideResponse})
