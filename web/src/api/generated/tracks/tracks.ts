 ...
 * @summary List Tracks
 */
export const listTracksApiV1TracksGet = async (params?: ListTracksApiV1TracksGetParams, options?: Parameters<typeof customFetch>[1]): Promise<listTracksApiV1TracksGetResponse> => {
 ...
 */
export const getTrackDetailApiV1TracksTrackIdGet = async (trackId: string, options?: Parameters<typeof customFetch>[1]): Promise<getTrackDetailApiV1TracksTrackIdGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTrackDetailApiV1TracksTrackIdGetQueryKey(trackId);
   ...
   return  { queryKey, queryFn, enabled: trackId !== null && trackId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTrackDetailApiV1TracksTrackIdGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const unlinkMappingApiV1TracksTrackIdMappingsMappingIdDelete = async (trackId: string,
    mappingId: string, options?: Parameters<typeof customFetch>[1]): Promise<unlinkMappingApiV1TracksTrackIdMappingsMappingIdDeleteResponse> => {
...
export const setPrimaryMappingApiV1TracksTrackIdMappingsMappingIdPrimaryPatch = async (trackId: string,
    mappingId: string, options?: Parameters<typeof customFetch>[1]): Promise<setPrimaryMappingApiV1TracksTrackIdMappingsMappingIdPrimaryPatchResponse> => {
 ...
 */
export const deleteTrackPreferenceApiV1TracksTrackIdPreferenceDelete = async (trackId: string, options?: Parameters<typeof customFetch>[1]): Promise<deleteTrackPreferenceApiV1TracksTrackIdPreferenceDeleteResponse> => {
...
export const deleteTrackTagApiV1TracksTrackIdTagsTagDelete = async (trackId: string,
    tag: string, options?: Parameters<typeof customFetch>[1]): Promise<deleteTrackTagApiV1TracksTrackIdTagsTagDeleteResponse> => {
