...
export const getSetConnectorPlayPollingApiV1ConnectorsServicePlayPollingPutResponseMock = (overrideResponse: Partial<Extract<PlayPollingResponse, object>> = {}): PlayPollingResponse => ({enabled: faker.datatype.boolean(), interval_minutes: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), next_run_at: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), ...overrideResponse})

export const getGetConnectorPlayPollingApiV1ConnectorsServicePlayPollingGetResponseMock = (overrideResponse: Partial<Extract<PlayPollingResponse, object>> = {}): PlayPollingResponse => ({enabled: faker.datatype.boolean(), interval_minutes: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), next_run_at: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), ...overrideResponse})
