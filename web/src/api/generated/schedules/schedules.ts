 ...
 */
export const listSchedulesApiV1SchedulesGet = async ( options?: Parameters<typeof customFetch>[1]): Promise<listSchedulesApiV1SchedulesGetResponse> => {
 ...
 */
export const getSyncScheduleApiV1SyncSchedulesTargetIdGet = async (targetId: string, options?: Parameters<typeof customFetch>[1]): Promise<getSyncScheduleApiV1SyncSchedulesTargetIdGetResponse> => {
 ...
 */
export const deleteSyncScheduleApiV1SyncSchedulesTargetIdDelete = async (targetId: string, options?: Parameters<typeof customFetch>[1]): Promise<deleteSyncScheduleApiV1SyncSchedulesTargetIdDeleteResponse> => {
