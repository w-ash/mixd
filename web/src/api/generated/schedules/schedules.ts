...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSyncScheduleApiV1SyncSchedulesTargetIdGetQueryKey(targetId);
   ...
   return  { queryKey, queryFn, enabled: !!(targetId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSyncScheduleApiV1SyncSchedulesTargetIdGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
