 ...
 */
export const applyAssignmentApiV1PlaylistAssignmentsAssignmentIdApplyPost = async (assignmentId: string, options?: Parameters<typeof customFetch>[1]): Promise<applyAssignmentApiV1PlaylistAssignmentsAssignmentIdApplyPostResponse> => {
 ...
 */
export const applyBulkAssignmentsApiV1PlaylistAssignmentsApplyBulkPost = async ( options?: Parameters<typeof customFetch>[1]): Promise<applyBulkAssignmentsApiV1PlaylistAssignmentsApplyBulkPostResponse> => {
 ...
 */
export const deleteAssignmentApiV1PlaylistAssignmentsAssignmentIdDelete = async (assignmentId: string, options?: Parameters<typeof customFetch>[1]): Promise<deleteAssignmentApiV1PlaylistAssignmentsAssignmentIdDeleteResponse> => {
