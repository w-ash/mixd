 ...
 */
export const streamOperationProgressApiV1OperationsOperationIdProgressGet = async (operationId: string, options?: Parameters<typeof customFetch>[1]): Promise<streamOperationProgressApiV1OperationsOperationIdProgressGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getStreamOperationProgressApiV1OperationsOperationIdProgressGetQueryKey(operationId);
   ...
   return  { queryKey, queryFn, enabled: operationId !== null && operationId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof streamOperationProgressApiV1OperationsOperationIdProgressGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
 ...
 */
export const getOperationSnapshotApiV1OperationsOperationIdSnapshotGet = async (operationId: string, options?: Parameters<typeof customFetch>[1]): Promise<getOperationSnapshotApiV1OperationsOperationIdSnapshotGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetOperationSnapshotApiV1OperationsOperationIdSnapshotGetQueryKey(operationId);
   ...
   return  { queryKey, queryFn, enabled: operationId !== null && operationId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getOperationSnapshotApiV1OperationsOperationIdSnapshotGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
