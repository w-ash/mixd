...
import type {
  ...
  SyncLinkRequest as __SyncLinkRequest,
  SyncPreviewResponse,
  SyncStartedResponse,
  UpdateLinkRequest,
...
export const syncPlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdSyncPost = async (playlistId: string,
    linkId: string,
    _syncLinkRequestNull: __SyncLinkRequest | null, options?: RequestInit): Promise<syncPlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdSyncPostResponse> => {
...
export const getSyncPlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdSyncPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof syncPlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdSyncPost>>, TError,{playlistId: string;linkId: string;data: __SyncLinkRequest | null}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof syncPlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdSyncPost>>, TError,{playlistId: string;linkId: string;data: __SyncLinkRequest | null}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof syncPlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdSyncPost>>, {playlistId: string;linkId: string;data: __SyncLinkRequest | null}> = (props) => {
          const {playlistId,linkId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SyncPlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdSyncPostMutationBody = __SyncLinkRequest | null
...
export const useSyncPlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdSyncPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {playlistId: string;linkId: string;data: __SyncLinkRequest | null},
        TContext
      > => {
