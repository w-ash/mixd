...
export const getListPlaylistLinksApiV1PlaylistsPlaylistIdLinksGetResponseMock = (): PlaylistLinkSchema[] => (Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), connector_name: faker.string.alpha({length: {min: 10, max: 20}}), connector_playlist_identifier: faker.string.alpha({length: {min: 10, max: 20}}), connector_playlist_name: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), sync_direction: faker.string.alpha({length: {min: 10, max: 20}}), sync_status: faker.string.alpha({length: {min: 10, max: 20}}), last_synced: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), last_sync_error: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), last_sync_tracks_added: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), last_sync_tracks_removed: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), last_sync_tracks_unmatched: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined])})))

export const getCreatePlaylistLinkApiV1PlaylistsPlaylistIdLinksPostResponseMock = (overrideResponse: Partial<Extract<PlaylistLinkSchema, object>> = {}): PlaylistLinkSchema => ({id: faker.string.uuid(), connector_name: faker.string.alpha({length: {min: 10, max: 20}}), connector_playlist_identifier: faker.string.alpha({length: {min: 10, max: 20}}), connector_playlist_name: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), sync_direction: faker.string.alpha({length: {min: 10, max: 20}}), sync_status: faker.string.alpha({length: {min: 10, max: 20}}), last_synced: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), last_sync_error: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), last_sync_tracks_added: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), last_sync_tracks_removed: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), last_sync_tracks_unmatched: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), ...overrideResponse})

export const getUpdatePlaylistLinkApiV1PlaylistsPlaylistIdLinksLinkIdPatchResponseMock = (overrideResponse: Partial<Extract<PlaylistLinkSchema, object>> = {}): PlaylistLinkSchema => ({id: faker.string.uuid(), connector_name: faker.string.alpha({length: {min: 10, max: 20}}), connector_playlist_identifier: faker.string.alpha({length: {min: 10, max: 20}}), connector_playlist_name: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), sync_direction: faker.string.alpha({length: {min: 10, max: 20}}), sync_status: faker.string.alpha({length: {min: 10, max: 20}}), last_synced: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), last_sync_error: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), last_sync_tracks_added: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), last_sync_tracks_removed: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), last_sync_tracks_unmatched: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), ...overrideResponse})

export const getPreviewPlaylistSyncApiV1PlaylistsPlaylistIdLinksLinkIdSyncPreviewGetResponseMock = (overrideResponse: Partial<Extract<SyncPreviewResponse, object>> = {}): SyncPreviewResponse => ({tracks_to_add: faker.number.int(), tracks_to_remove: faker.number.int(), tracks_unchanged: faker.number.int(), direction: faker.string.alpha({length: {min: 10, max: 20}}), connector_name: faker.string.alpha({length: {min: 10, max: 20}}), playlist_name: faker.string.alpha({length: {min: 10, max: 20}}), has_comparison_data: faker.datatype.boolean(), safety_flagged: faker.datatype.boolean(), safety_message: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), ...overrideResponse})
