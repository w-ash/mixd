 ...
 */
export const getDashboardStatsApiV1StatsDashboardGet = async ( options?: Parameters<typeof customFetch>[1]): Promise<getDashboardStatsApiV1StatsDashboardGetResponse> => {
 ...
 */
export const getMatchingHealthApiV1StatsMatchingGet = async (params?: GetMatchingHealthApiV1StatsMatchingGetParams, options?: Parameters<typeof customFetch>[1]): Promise<getMatchingHealthApiV1StatsMatchingGetResponse> => {
