 ...
 */
export const listReviewsApiV1ReviewsGet = async (params?: ListReviewsApiV1ReviewsGetParams, options?: Parameters<typeof customFetch>[1]): Promise<listReviewsApiV1ReviewsGetResponse> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof resolveReviewApiV1ReviewsReviewIdResolvePost>>, {reviewId: string;data: ResolveReviewRequest}> = (props) => {
        ...
        const customOptions = withCacheTags({...mutationOptions, mutationFn}, { url: `/api/v1/reviews/{reviewId}/resolve` });
