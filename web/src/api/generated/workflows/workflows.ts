 ...
 */
export const listWorkflowsApiV1WorkflowsGet = async (params?: ListWorkflowsApiV1WorkflowsGetParams, options?: Parameters<typeof customFetch>[1]): Promise<listWorkflowsApiV1WorkflowsGetResponse> => {
 ...
 */
export const listWorkflowTemplatesApiV1WorkflowsTemplatesGet = async ( options?: Parameters<typeof customFetch>[1]): Promise<listWorkflowTemplatesApiV1WorkflowsTemplatesGetResponse> => {
 ...
 */
export const useWorkflowTemplateApiV1WorkflowsTemplatesTemplateIdUsePost = async (templateId: string, options?: Parameters<typeof customFetch>[1]): Promise<useWorkflowTemplateApiV1WorkflowsTemplatesTemplateIdUsePostResponse> => {
 ...
 */
export const duplicateWorkflowApiV1WorkflowsWorkflowIdDuplicatePost = async (workflowId: string, options?: Parameters<typeof customFetch>[1]): Promise<duplicateWorkflowApiV1WorkflowsWorkflowIdDuplicatePostResponse> => {
 ...
 */
export const listNodeTypesApiV1WorkflowsNodesGet = async ( options?: Parameters<typeof customFetch>[1]): Promise<listNodeTypesApiV1WorkflowsNodesGetResponse> => {
 ...
 */
export const listActiveRunsApiV1WorkflowsActiveRunsGet = async (params?: ListActiveRunsApiV1WorkflowsActiveRunsGetParams, options?: Parameters<typeof customFetch>[1]): Promise<listActiveRunsApiV1WorkflowsActiveRunsGetResponse> => {
 ...
 */
export const getWorkflowApiV1WorkflowsWorkflowIdGet = async (workflowId: string, options?: Parameters<typeof customFetch>[1]): Promise<getWorkflowApiV1WorkflowsWorkflowIdGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowApiV1WorkflowsWorkflowIdGetQueryKey(workflowId);
   ...
   return  { queryKey, queryFn, enabled: workflowId !== null && workflowId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowApiV1WorkflowsWorkflowIdGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
 ...
 */
export const runWorkflowEndpointApiV1WorkflowsWorkflowIdRunPost = async (workflowId: string, options?: Parameters<typeof customFetch>[1]): Promise<runWorkflowEndpointApiV1WorkflowsWorkflowIdRunPostResponse> => {
...
export const listWorkflowRunsApiV1WorkflowsWorkflowIdRunsGet = async (workflowId: string,
    params?: ListWorkflowRunsApiV1WorkflowsWorkflowIdRunsGetParams, options?: Parameters<typeof customFetch>[1]): Promise<listWorkflowRunsApiV1WorkflowsWorkflowIdRunsGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListWorkflowRunsApiV1WorkflowsWorkflowIdRunsGetQueryKey(workflowId,params);
   ...
   return  { queryKey, queryFn, enabled: workflowId !== null && workflowId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listWorkflowRunsApiV1WorkflowsWorkflowIdRunsGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getWorkflowRunApiV1WorkflowsWorkflowIdRunsRunIdGet = async (workflowId: string,
    runId: string, options?: Parameters<typeof customFetch>[1]): Promise<getWorkflowRunApiV1WorkflowsWorkflowIdRunsRunIdGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowRunApiV1WorkflowsWorkflowIdRunsRunIdGetQueryKey(workflowId,runId);
   ...
   return  { queryKey, queryFn, enabled: workflowId !== null && workflowId !== undefined && runId !== null && runId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowRunApiV1WorkflowsWorkflowIdRunsRunIdGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
 ...
 */
export const listWorkflowVersionsApiV1WorkflowsWorkflowIdVersionsGet = async (workflowId: string, options?: Parameters<typeof customFetch>[1]): Promise<listWorkflowVersionsApiV1WorkflowsWorkflowIdVersionsGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListWorkflowVersionsApiV1WorkflowsWorkflowIdVersionsGetQueryKey(workflowId);
   ...
   return  { queryKey, queryFn, enabled: workflowId !== null && workflowId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listWorkflowVersionsApiV1WorkflowsWorkflowIdVersionsGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getWorkflowVersionApiV1WorkflowsWorkflowIdVersionsVersionGet = async (workflowId: string,
    version: number, options?: Parameters<typeof customFetch>[1]): Promise<getWorkflowVersionApiV1WorkflowsWorkflowIdVersionsVersionGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowVersionApiV1WorkflowsWorkflowIdVersionsVersionGetQueryKey(workflowId,version);
   ...
   return  { queryKey, queryFn, enabled: workflowId !== null && workflowId !== undefined && version !== null && version !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowVersionApiV1WorkflowsWorkflowIdVersionsVersionGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const revertWorkflowVersionApiV1WorkflowsWorkflowIdVersionsVersionRevertPost = async (workflowId: string,
    version: number, options?: Parameters<typeof customFetch>[1]): Promise<revertWorkflowVersionApiV1WorkflowsWorkflowIdVersionsVersionRevertPostResponse> => {
 ...
 */
export const getWorkflowScheduleApiV1WorkflowsWorkflowIdScheduleGet = async (workflowId: string, options?: Parameters<typeof customFetch>[1]): Promise<getWorkflowScheduleApiV1WorkflowsWorkflowIdScheduleGetResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowScheduleApiV1WorkflowsWorkflowIdScheduleGetQueryKey(workflowId);
   ...
   return  { queryKey, queryFn, enabled: workflowId !== null && workflowId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowScheduleApiV1WorkflowsWorkflowIdScheduleGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
 ...
 */
export const deleteWorkflowScheduleApiV1WorkflowsWorkflowIdScheduleDelete = async (workflowId: string, options?: Parameters<typeof customFetch>[1]): Promise<deleteWorkflowScheduleApiV1WorkflowsWorkflowIdScheduleDeleteResponse> => {
