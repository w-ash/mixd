 ...
 * @summary List Tags
 */
export const listTagsApiV1TagsGet = async (params?: ListTagsApiV1TagsGetParams, options?: Parameters<typeof customFetch>[1]): Promise<listTagsApiV1TagsGetResponse> => {
 ...
 * @summary Delete Tag
 */
export const deleteTagApiV1TagsTagDelete = async (tag: string, options?: Parameters<typeof customFetch>[1]): Promise<deleteTagApiV1TagsTagDeleteResponse> => {
