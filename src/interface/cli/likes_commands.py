...
def _show_interactive_likes_menu() -> None:
    ...
    console.print("  [cyan]1[/cyan]. [bold]Import from Spotify[/bold] - Bring your Spotify liked tracks into your library")
    console.print("  [cyan]2[/cyan]. [bold]Export to Last.fm[/bold] - Mark your liked tracks as loved on Last.fm")
