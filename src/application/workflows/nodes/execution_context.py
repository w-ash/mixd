...
class NodeContext:
    ...
    def extract_tracklist(self) -> TrackList:
        ...
        """
        # Check for workflow context with upstream task — data dict is the
        # executor's heterogeneous context (task results, metadata, workflow_context), inherently Any-valued
    ...
    def collect_tracklists(self, task_ids: list[str]) -> list[TrackList]:
        ...
        for task_id in task_ids:
            ...
            task_result: object = self.data[task_id]  # executor context dict
