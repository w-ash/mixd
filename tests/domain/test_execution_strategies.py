...
def reordered_playlist(sample_tracks):
    ...
    reordered_tracks = [sample_tracks[2], sample_tracks[0], sample_tracks[1], sample_tracks[4], sample_tracks[3]]
    return Playlist(
        name="Test Playlist",
...
class TestCanonicalExecutionStrategy:
    ...
    def test_plan_operations_uses_atomic_reorder(self, sample_playlist, reordered_playlist):
    ...
    def test_can_optimize_to_reorder_always_true(self, sample_playlist, reordered_playlist):
...
class TestAPIExecutionStrategy:
    ...
    def test_plan_operations_uses_sequential_execution(self, sample_playlist, reordered_playlist):
    ...
    def test_can_optimize_to_reorder_always_false(self, sample_playlist, reordered_playlist):
...
class TestExecuteWithStrategy:
    ...
    def test_execute_with_canonical_strategy(self, sample_playlist, reordered_playlist):
        ...
        assert [track.id for track in updated_tracks] == [track.id for track in reordered_playlist.tracks]
    ...
    def test_execute_with_no_changes(self, sample_playlist):
        ...
        assert [track.id for track in updated_tracks] == [track.id for track in sample_playlist.tracks]