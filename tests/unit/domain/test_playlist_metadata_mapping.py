...
class TestValidateActionValue:
    ...
    def test_invalid_preference_rejected(self) -> None:
        with pytest.raises(ValueError, match="hmm/nah/yah/star"):
...
class TestConstructor:
    ...
    def test_non_canonical_tag_rejected(self) -> None:
        """Direct construction should refuse unnormalized input so CLI /
        migration callers can't silently persist garbage."""
