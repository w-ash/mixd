...
class TestThreadPoolConfiguration:
    ...
    async def test_default_executor_configuration(self):
        ...
        try:
            ...
            assert overall_duration < call_duration * 1.5, f"Not concurrent: {overall_duration:.3f}s"
        ...
        try:
            ...
            for completed_task in asyncio.as_completed(tasks):
                ...
                if completed_count % 10 == 0:
                    ...
                    print(f"   {completed_count}/{num_calls} completed at {elapsed:.1f}s")
            ...
            if total_time < 2.0:
                ...
                assert unique_threads >= 40, f"Should use many threads: {unique_threads}"
            else:
    ...
    async def test_thread_pool_sizing_recommendations(self):
        ...
        for pool_size in pool_sizes:
            try:
                ...
                print(f"   {pool_size:3d} threads: {duration:.3f}s, used {unique_threads} threads")
        ...
        for size, result in results_by_size.items():
            ...
            if efficiency > 0.95 and size >= 50:
                print(f"   ✅ Recommended: {size} threads (good efficiency for 50+ calls)")
                break
