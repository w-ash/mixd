...
class TestProgressIntegration:
    ...
    async def test_complete_progress_flow(self, progress_manager, rich_provider):
        ...
        events = [
            ...
            create_progress_event(operation_id, 100, 100, "Finalizing...", ProgressStatus.COMPLETED)
        ]
    ...
    @pytest.mark.asyncio
    async def test_multiple_concurrent_operations(self, progress_manager, rich_provider):
    ...
    async def test_indeterminate_progress(self, progress_manager, rich_provider):
        ...
        events = [
            ...
            create_progress_event(operation_id, 500, None, "Scan complete - found 500 files"),
        ]
    ...
    async def test_progress_validation_enforcement(self, progress_manager):
        ...
        invalid_event = create_progress_event(operation_id, 15, 100, "Backwards progress")
    ...
    async def test_subscriber_error_isolation(self, progress_manager):
        ...
        failing_subscriber.on_operation_started.side_effect = Exception("Subscriber error")
        failing_subscriber.on_operation_completed.side_effect = Exception("Subscriber error")
        ...
        operation = create_progress_operation(description="Test with failing subscriber")
        operation_id = await progress_manager.start_operation(operation)
