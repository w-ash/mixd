...
**Audience**: savvy DJs, tastemakers, crate-diggers curating playlists for friends. They care about music deeply and expect a tool that reflects that care.

**The feel**: a dim-lit record shop crossed with a design magazine. Dark mode is the default experience, not an afterthought — album art glows against warm dark surfaces, and data is presented with editorial confidence.

> The test for any screen: this should feel like a tool built by someone who cares about music, not generated by an AI that doesn't know what a record sounds like.
