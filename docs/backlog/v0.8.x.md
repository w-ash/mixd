...
- [ ] **LLM Feedback Collection**
    ...
    - Why: Improve generation quality through direct user signal — but right-sized for <10 users, not a platform
    ...
    - Notes:
        ...
        - **Not building**: A/B testing (meaningless with <10 users), feedback insights dashboard (query the DB directly), automated model improvement framework (manual iteration is fine at this scale)
