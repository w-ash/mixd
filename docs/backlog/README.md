...
**Next**: v0.8.14–v0.8.17 The Fable Sweep execution waves (Wave 1 shipped as v0.8.13; Fable-executor spokes inside the window through 2026-07-07); then v0.9.0 Workflow assistant — right-panel chat ported from couplefins
