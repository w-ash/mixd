...
- **v0.10.2.2** (2026-08-02) — Import failures surface their reason: the run's Import History row now records the failure message, connector retries honor a 429's `Retry-After`, and import logs stop claiming success on soft failures — the fix for the first at-scale GDPR upload dying with an unexplained `errors: 1`. [changelog](../../CHANGELOG.md#01022--2026-08-02)
