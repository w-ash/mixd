...
| **v0.10.4** | Play history surfaces — global play feed with chart navigator, per-track history on Track Detail, Library sort/filter by play count and recency (default: most recently played) | 🔜 Not Started | [details](v0.10.x.md#v0104-play-history-surfaces) |
