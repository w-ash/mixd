...
- **v0.10.2.6–2.8** (2026-08-08) — One deploy finishing the import-hardening train: hand mixd the whole GDPR export and walk away (server-side queue, per-file records), the full Last.fm import drops from a measured 4–6h to under one (batch-first path, 7-day windows), and unattended runs are safe (startup liveness reaper, pre-deploy busy gate). [changelog](../../CHANGELOG.md#01028--2026-08-08)
