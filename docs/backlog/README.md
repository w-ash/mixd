...
**Next**: v0.7.5 Workflow Integration & Quick Filters
...
| **v0.7.4** | Tag & preference bootstrap — bulk-map playlists to tags/preferences | ✅ Completed | [details](v0.7.4-5.md#v074-tag--preference-bootstrap) |
