...
**Next**: v0.8.14–v0.8.17 The Fable Sweep execution waves (Wave 1 shipped as v0.8.13; Fable-executor spokes inside the window through 2026-07-07). Two doc-only investigation briefs share the window per the 2026-07-02 sequencing review: the [v0.9.x Pre-Work brief](v0.9.x.md#pre-work-2026-mcp--chatbot-best-practices-pass--sequencing-review) and the [identity-resolution research pass](identity-resolution-research-handoff.md) (design-space memo feeding v1.0.0/v1.0.1/v1.0.3, extended to artist identity for v0.10.0) — investigation is where Fable's premium is largest, and neither collides with sweep code. Then v0.9.0 Workflow assistant — right-panel chat ported from couplefins
