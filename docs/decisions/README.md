...
- [PDR-003: Spotify dev-mode batch-endpoint exposure](PDR-003-spotify-dev-mode-batch-endpoints.md) — what happens to the batched import fast path if the postponed Feb-2026 restrictions land
