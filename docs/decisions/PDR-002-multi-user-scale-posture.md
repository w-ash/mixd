...
| **3 — Unanchored cross-user sharing / trust machinery** | any, once sharing long-tail content matters | A real feature needs sharing *unverifiable* identities AND ring-2 identity cost exists | v1.1.0's parked TrustScore, gated on invite-tree cost — never activity-earned reputation | ⏸ Parked in v1.1.0 spec with this exact trigger |
...
| 2026-08-20 | [S] | developer.spotify.com program docs + 2025-04-15 extended-access blog (2026-08 research pass) | Development mode caps each app at 5 authorized Spotify users and requires the owner to hold active Premium (2026-03-09); extended quota requires an organization with ≥250k MAU | Ring-1+ planning: a deployment cannot exceed 5 Spotify-connected users; BYO-Client-ID-per-deployment is the Spotify scaling unit | Official program facts; `re-verify` |
...
- 2026-07-02 — Opened. Rings 0–1 decided and specced (links-first sequencing in v1.1.x, no vanity metrics, invite-provenance permanent, anchor-only public resolution in v1.2.0, TrustScore parked in v1.1.0 with ring-3's trigger). Owner framing: "maybe 10 people ever use this, but if it takes off I want to be ready" — readiness defined as *this ladder*, not pre-built machinery. Full evidence base: [identity-governance-design-space.md](../backlog/identity-governance-design-space.md).
