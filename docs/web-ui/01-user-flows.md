...
3. "Albums by this artist" section links into flow 8.4 (after v0.12.2).
...
| Action | Endpoint | Use Case | Status |
|--------|----------|----------|--------|
| List/search albums | `GET /api/v1/albums` | `ListAlbumsUseCase` | 🔜 Planned (v0.12.2) |
...
2. After v0.13.1: "You own this" badge with pressing details. After v0.13.2: "Log a listen" button (flow 9.3) and "Recent listens".

**Backend calls**:
| Action | Endpoint | Use Case | Status |
|--------|----------|----------|--------|
| Detail + tracks | `GET /api/v1/albums/{id}` | `GetAlbumDetailUseCase` | 🔜 Planned (v0.12.2) |
...
> **Planned for v0.11.1 (Discogs client), v0.13.1 (collection import), and v0.13.2 (manual listens).** Backlog: [v0.11.x](../backlog/v0.11.x.md), [v0.13.x](../backlog/v0.13.x.md). All endpoints below are 🔜 Planned.
...
| Action | Endpoint | Use Case | Status |
|--------|----------|----------|--------|
| Save/validate token | connector settings (Anthropic-key pattern) | token storage | 🔜 Planned (v0.11.1) |
| Import collection | `POST /api/v1/connectors/discogs/collection/import` | `ImportDiscogsCollectionUseCase` | 🔜 Planned (v0.13.1) |
...
| Action | Endpoint | Use Case | Status |
|--------|----------|----------|--------|
| List collection | `GET /api/v1/collection` | `ListCollectionUseCase` | 🔜 Planned (v0.13.1) |
...
| Action | Endpoint | Use Case | Status |
|--------|----------|----------|--------|
| Log listen | `POST /api/v1/albums/{id}/listens` | `RecordAlbumListenUseCase` | 🔜 Planned (v0.13.2) |
